...
- **(2)** in subsection (d)—
  - **(A)** in paragraph (1)—
    ...
    - **(ii)** in the matter preceding subparagraph (A), by striking “emerging technologies for snowpack measurement, such as” and inserting “technologies for snowpack measurements and models, including”;
...
- **(4)** in subsection (f)—
  ...
  - **(D)** by striking paragraph (1) and inserting the following:
    ...
    > - **(2)** an assessment of which technologies best inform water supply forecasting for multiple water districts, communities, or States; and
