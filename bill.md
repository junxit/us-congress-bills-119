...
- **(a)** *Risk assessment* The Secretary shall conduct a risk assessment, on a biennial basis, on the cybersecurity threats to, and security vulnerabilities in, the agriculture and food critical infrastructure sector, including—
...
- **(d)** *Private sector participation* In conducting an exercise under subsection (a), the Secretary shall consult with appropriate entities in the private sector, including—
  - **(1)** the sector-specific ISAC; and
