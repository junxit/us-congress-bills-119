...
- **(b)** *Commercial Satellite Data Acquisition Program*
  - **(1)** *In general* Chapter 603 of title 51, United States Code, is amended by adding at the end the following:
    ...
    >   - **(1)**
    >     - **(A)** In the case of the initial report, a list of all vendors that are providing commercial Earth remote sensing data and imagery to NASA as of the date of the report.
