...
- **(a)** *In general* Section 510 of title 32, United States Code, is amended—
  - **(1)** in subsection (a)—
    ...
    - **(B)** by inserting “of record” after “carry out a program”; and
    - **(C)** by striking “Such a program” and inserting “Such program”; and
  - **(2)** by adding at the end the following new subsections:
    ...
    > - **(d)** *Sunset* The FireGuard Program shall terminate on December 31, 2031.

- **(b)** *Clerical amendment* The heading of such section is amended by striking “Authorization for”.
