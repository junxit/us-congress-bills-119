...
## § 2. Integration of treatment plans for homeless individuals
...
- **(d)** *Authorization of appropriations*
  ...
  - **(2)** *Set-aside* Of amounts made available under paragraph (1), the Secretary may set aside 10 percent of such amounts to—
    - **(A)** provide technical assistance to eligible entities; and
    - **(B)** complete the report described in subsection (c).
