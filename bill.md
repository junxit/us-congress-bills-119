...
- **(c)** *Contents*
  - **(1)** *In general* In conducting the study under subsection (b), the Comptroller General shall determine for each year during the period beginning on January 1, 2021, and ending on December 31, 2024, for each covered region, the measures described in paragraph (2).
...
- **(d)** *Briefing and report*
  ...
  - **(2)** *Report*
    ...
    - **(B)** *Recommendations* The report required by subparagraph (A) shall include recommendations of the Comptroller General for changes to the small business loan disbursement process to—
      ...
      - **(iv)** identify mechanisms and processes internal to the agencies involved in making small business loans that can be changed to reduce inefficiencies of the Government with respect to the processing of applications for small business loans.
