...
- **(10)** All records, logs, code, certificates, and configurations for all Federal IT assets, databases, or repositories accessed by employees of DOGE in training or deploying new AI software.
