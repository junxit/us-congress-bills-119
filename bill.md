...
- **(b)** *No application required* The Commissioner shall carry out the liquidations and reliquidations required by subsection (a) without requiring any importer of record to file an application or protest to be eligible for the refunds required by such subsection, and shall use all information otherwise available to the Commissioner to calculate and disburse the amounts owed.
- **(c)** *Entry defined* For purposes of this section, the term “entry” includes a withdrawal from warehouse for consumption.
