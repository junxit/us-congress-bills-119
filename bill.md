...
- **(1)** *Advanced artificial intelligence system*
  - **(A)** *In general* Subject to subparagraph (B), the term advanced artificial intelligence system means an artificial intelligence system that was trained using a quantity of computing power greater than 1026 integer or floating-point operations.
