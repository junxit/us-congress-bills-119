...
- **(b)** *Review of programs*
  - **(1)** *In general* The Administrator and the Commissioner shall jointly conduct a review of the eligibility determination and application processes, procedures, forms, and communications of Medicare, Medicaid, CHIP, and the Social Security programs.
...
- **(d)** *Report to Congress*
  ...
  - **(3)** *Updated reports* The covered officials shall each submit a report 2 years after submitting the report required under paragraph (1) providing an update to the contents identified in paragraph (2).
