...
- **(a)** *In general* Beginning on the date that is 90 days after the date of the enactment of this Act, no mineral specified in subsection (b) may be imported into the United States if the mineral is—
  - **(1)** produced in the Russian Federation or by a Russian entity; or
  - **(2)** determined to have been exchanged with, swapped for, or otherwise obtained in lieu of a mineral described in paragraph (1) in a manner designed to evade or circumvent the application of this section.
- **(b)** *Minerals specified* The minerals specified in this subsection are the following:
  - **(1)** Platinum, unwrought or in semimanufactured forms, classified under heading 7110 of the Harmonized Tariff Schedule of the United States (in this Act, referred to as the “HTS”), including—
    - **(A)** palladium;
    - **(B)** braggite;
    - **(C)** rhodium; and
    - **(D)** ruthenium.
  - **(2)** Nickel classified under heading 2604 of the HTS.
  - **(3)** Copper, ores and concentrates, classified under heading 2603 of the HTS, including zinc.
- **(c)** *Termination*
