...
> To authorize the Secretary of Health and Human Services to make grants to States to improve the knowledge, credentials, compensation, and professional development of early childhood educators working with children in early childhood education programs, and for other purposes.
...
- **(a)** *In general* Each State desiring a grant under this Act shall submit an application to the Secretary of Health and Human Services—
  - **(1)** that includes the information described in subsection (b); and
...
- **(b)** *Contents* Each application submitted under subsection (a) shall include a description of the State’s comprehensive early childhood professional development system, including the following:
  ...
  - **(3)** A description of how the State’s comprehensive early childhood professional development system provides—
    ...
    - **(H)** training and expertise that reflects linguistically and culturally appropriate education and practices; and
    - **(I)** use of workforce data to assess State and local workforce needs.
  - **(4)** A description of the financing of the State’s comprehensive early childhood professional development system over time.
...
There are authorized to be appropriated to carry out this Act such sums as may be necessary for fiscal years 2027 through 2032.
