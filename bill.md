...
- **(a)** *In general* Chapter 44 of title 18, United States Code, is amended—
  ...
  - **(2)** in section 922, by inserting after subsection (u) the following:
    ...
    >     - **(B)** any device, part, or combination of parts, that is designed or functions to materially increase the rate of fire of a firearm, by eliminating the need for the operator of the firearm to make a separate movement for each individual function of the trigger; or
