...
- **(b)** *Establishment of a grant program*
  ...
  - **(4)** *Application*
    ...
    - **(B)** *Initiatives* Initiatives that meet the criteria described in paragraph (3)(D) include—
...
- **(d)** *Authorization of appropriations*
  ...
  - **(2)** *Adjustment* The amount authorized to be appropriated under paragraph (1) shall be adjusted for inflation based on the Consumer Price Index.
