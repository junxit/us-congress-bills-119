...
- **(a)** *Requirement for ADS-B In operation*
  ...
  - **(3)** *Final regulation requirements* In issuing a final rule under paragraph (1), the Administrator shall, at a minimum, do the following:
    ...
    - **(C)** *Guidance* The Administrator shall issue relevant guidance for aircraft operators and other appropriate stakeholders regarding the types of equipment that satisfy the performance requirements described in this paragraph.
