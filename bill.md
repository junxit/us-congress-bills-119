...
- **(a)** *Northern border threat analysis* Subsection (a) of section 3 of the Northern Border Security Review Act (Public Law 114–267) is amended, the matter preceding paragraph (1), by striking “180 days after the date of enactment of this Act” and inserting “September 2, 2026, and biennially thereafter”.
- **(b)** *Northern border strategy updates* Section 3 of the Northern Border Security Review Act is amended by—
...
- **(c)** *Classified briefings* Section 3 of the Northern Border Security Review Act, as amended by subsection (b), is further amended by adding at the end the following new subsection:
