...
- **(1)** *Requirement for rule* An agency may not issue a rule unless such agency has repealed ten or more rules described in paragraph (4) that, to the extent practicable, are related to the rule.
...
- **(6)** *Report on rules* Not later than 5 years after the date of the enactment of this Act, the President shall submit to Congress a report on the number of rules in effect and the status of the reduction of rules over the previous 5 years.
