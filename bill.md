...
- **(1)** in subsection (a)(10)(A)(ii)—
  ...
  - **(C)** by adding at the end the following new subclause:
    > - **(XXIV)** specified individuals (as defined in paragraph (1) of subsection (yy)), subject to the provisions of such subsection;

- **(2)** by adding at the end the following new subsection:
  > - **(yy)** *Specified individuals*
  >   - **(1)** *Definition* For purposes of subsection (a)(10)(A)(ii)(XXIV), the term “specified individual” means an individual—
  >     - **(A)** who is an uninsured individual (as defined in subsection (ss));
  >     - **(B)** whose income (as determined under subsection (e)(14)) does not exceed 100 percent of the poverty line (as defined in section 2110(c)(5)) applicable to a family of the size involved; and
  ...
  >     - **(B)** agree to report the behavioral health measures of the Core Set of Adult Health Care Quality Measures for Medicaid with respect to such individuals in accordance with section 1139B.
