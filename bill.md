...
- **(a)** *Updating of purposes*
  - **(1)** *In general* Section 477(a) of the Social Security Act (42 U.S.C. 677(a)) is amended—
    - **(A)** by striking paragraph (2);
    - **(B)** by redesignating paragraphs (1) and (3) through (7) as paragraphs (3) through (8), respectively; and
    - **(C)** by inserting after “conducted—” the following:
  ...
  - **(2)** *Effective date* The amendments made by paragraph (1) shall take effect on the date that is 1 year after the date of the enactment of this Act.
