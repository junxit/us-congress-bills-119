...
- **(2)** in subsection (b)—
  ...
  - **(B)** by striking “When” and all that follows, and inserting the following:
    ...
    >   - **(B)** on the date such proposed change is submitted to the Postal Regulatory Commission, post a notice of the change within affected storefront postal facilities, to remain posted for no fewer than 30 days after the change has gone into effect, and such notice shall include—
    >     - **(i)** relevant details of the change;
    >     - **(ii)** associated timelines related to the implementation of the change;
    ...
    >     - **(vi)** other helpful resources as deemed necessary by the Postal Service.
...
- **(4)** in paragraph (2) of subsection (b) (as so redesignated)—
  ...
  - **(B)** by striking “proposal” and inserting “proposed change”.
