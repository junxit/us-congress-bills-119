...
- **(a)** *In general* To carry out this Act, there are authorized to be appropriated $250,000,000 for fiscal year 2026 and each of the five succeeding fiscal years.
...
- **(i)** *Application*
  ...
  - **(3)** *Assurances* The application under paragraph (1) shall include assurances from the eligible entity that—
    ...
    - **(B)** postsecondary credits earned by students under the program will be transcribed upon completion of the required coursework; and
