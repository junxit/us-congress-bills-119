...
## § 2. Plan to improve cybersecurity and telecommunications of U.S. Academic Research Fleet
...
- **(b)** *Elements* The plan required by subsection (a) shall include—
  ...
  - **(3)** an assessment of the costs necessary to meet the needs described in paragraphs (1) and (2), including—
    ...
    - **(C)** the estimated impact on daily charter rates associated with the costs described in subparagraphs (A) and (B);
