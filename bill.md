...
- **(a)** *In general* Subpart A of part IV of subchapter A of chapter 1 of the Internal Revenue Code of 1986 is amended by inserting after section 25E the following new section:
  > ## § 25F. Multigenerational home caregiver credit
  >
  ...
  >     - **(E)** who includes with the return of tax for the taxable year an attestation signed by a licensed health care provider that, to the best of the provider's knowledge, the qualified relative meets the requirements of clauses (iii) and (iv) of paragraph (2)(A).
  ...
  >         - **(II)** 3 instrumental activities of daily living,
  ...
  >     - **(B)** *Relationship* For purposes of subparagraph (A), a relationship described in this subparagraph is a relationship described in subparagraph (C), (D), (F), or (G) of section 152(d)(2), except that only a father-in-law or mother-in-law shall be taken into account for purposes of subparagraph (G) thereof.
