...
- **(1)** to avoid any cooperation with the People's Republic of China in the organ transplantation field while the Chinese Communist Party remains in power;
- **(2)** to take appropriate measures, including using relevant sanctions authorities, to coerce the Chinese Communist Party to end any state-sponsored organ harvesting campaign;
- **(3)** to work with allies, partners, and multilateral institutions to highlight the People's Republic of China’s persecution of Falun Gong; and
