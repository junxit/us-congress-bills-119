...
- **(b)** *Notice*
  - **(1)** *In general*
    ...
    - **(B)** *Review*
      ...
      - **(ii)** *State updates* In carrying out clause (i), the Secretary of Labor shall ensure that each State is given the opportunity to update the information included in the notice for such State.
...
- **(d)** *Definitions* In this Act:
  ...
  - **(2)** *Employer*
    ...
    - **(B)** *Public agency* For purposes of subparagraph (A)(ii)(III), a public agency shall be considered to be a person engaged in commerce or in an industry or activity affecting commerce.
...
- **(e)** *Effective dates*
  ...
  - **(2)** *Effective date for display requirement* Subsection (a) shall take effect on the date that is one year after the date of the enactment of this Act.
