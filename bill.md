...
- **(a)** *In general* Subpart C of part IV of subchapter A of chapter 1 of the Internal Revenue Code of 1986 is amending by inserting after section 36B the following new section:
  ...
  >     - **(B)** further reduced (but not below zero) by 1 percentage point for each $2,000 (or fraction thereof) by which the taxpayer’s adjusted gross income for the taxable year exceeds $150,000.
