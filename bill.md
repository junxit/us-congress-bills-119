...
- **(a)** *Authority To postpone Federal tax deadlines by reason of State-Declared disasters* Section 7508A of the Internal Revenue Code of 1986 is amended by redesignating subsections (c), (d), and (e) as subsections (d), (e), and (f), respectively, and by inserting after subsection (b) the following new subsection:
  ...
  >   - **(1)** *In general* The Secretary may, upon the written request of the Governor of a State (or the Mayor, in the case of the District of Columbia), apply the rules of subsection (a) to a qualified State declared disaster in the same manner as a disaster, fire, or action otherwise described in subsection (a).
