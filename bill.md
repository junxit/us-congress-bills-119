...
- **(b)** *Present or future public convenience and necessity determination* Section 7 of the Natural Gas Act (15 U.S.C. 717f) is amended by adding at the end the following:
  ...
  >     - **(D)** *Proposed action* The term proposed action means a proposed service, sale, operation, construction, extension, or acquisition, as described in subsection (e), in an application for a certificate.
