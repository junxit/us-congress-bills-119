...
- **(d)** *Disbursement of grant funds* Not later than 120 days after the date on which the Commission establishes the program under subsection (b), funds provided under each grant made under that subsection shall be disbursed to the eligible entity receiving the grant.
