...
- **(a)** *Inclusion of screening for stuttering and speech fluency in core set of child health quality measures* Section 1139A(b)(5) of the Social Security Act (42 U.S.C. 1320b–9a(b)(5)) is amended—
  ...
  - **(2)** by adding at the end the following new subparagraph:
    ...
    >   - **(i)** *In general* Not later than January 1, 2026, the Secretary shall publish changes to the core measures described in subsection (a) to include measures of screening for childhood-onset fluency disorders, including stuttering, for children who have attained the age of 2 (and have not attained the age of 6).
