...
- **(d)** *Eligible projects*
  - **(1)** *In general* A project eligible to be carried out with a grant under this section is a project described in paragraph (2) that—
  ...
  - **(2)** *Projects described* A project referred to in paragraph (1) is—
...
- **(h)** *Authorization of appropriations* There is authorized to be appropriated out of the Highway Trust Fund (other than the Mass Transit Account) $1,000,000,000 for each of fiscal years 2027 through 2031 to carry out this section.
