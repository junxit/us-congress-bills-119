...
- **(b)** *Maximum leverage exclusion* Section 303(b)(2) of the Small Business Investment Act of 1958 (15 U.S.C. 683(b)(2)) is amended—
  - **(1)** in subparagraph (A)—
    ...
    - **(B)** by striking clause (ii) and inserting the following:
      > - **(ii)**
      >   - **(I)** with respect to such a company that makes quarterly or semiannual interest payments, $175,000,000, as adjusted in accordance with subparagraph (E); or
  ...
  - **(3)** in subparagraph (C)—
    ...
    - **(B)** in clause (i)—
      ...
      - **(v)** by striking “the company in a smaller enterprise” and all that follows and inserting the following:
        ...
        > - **(III)** a small manufacturer (as defined in section 501(e) of this Act).
