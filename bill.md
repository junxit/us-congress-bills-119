...
- **(4)** in subsection (e)—
  ...
  - **(C)** by striking paragraphs (4) and (5) and inserting the following:
    ...
    >     - **(ii)** provide training to ensure that a third-party provider certified by the non-Federal certifying entity is qualified to provide that technical assistance; and
...
- **(5)** in subsection (f)—
  ...
  - **(D)** by striking paragraph (5) and inserting the following:
    ...
    > - **(6)** *Transparency* Not later than 1 year after the date of enactment of the Increased TSP Access Act of 2025, the Secretary shall provide accessible public information on—
