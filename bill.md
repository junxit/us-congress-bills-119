...
- **(a)** *In general* Section 2303 of title 38, United States Code, is amended—
  ...
  - **(2)** by inserting after subsection (b) the following new subsection (c):
    > - **(c)**
    >   - **(1)** In the case of an individual described in paragraph (2) who is buried in a cemetery that is owned by a State or by an agency or political subdivision of a State, the Secretary shall pay to such State, agency, or political subdivision the sum of $525 (as increased from time to time under subsection (d)) as a plot or interment allowance for such individual.
  ...
  - **(3)** in subsection (d), as redesignated by paragraph (1), by striking “subsection (b)” and inserting “subsections (b) and (c)”; and
  - **(4)** by striking “subsection (c)” each place it appears and inserting “subsection (d)”.
- **(b)** *Effective date* The amendments made by subsection (a) shall take effect on the date of the enactment of this Act and apply with respect to deaths occurring on or after such date.
