...
- **(a)** *In general* Section 403 of the Federal Food, Drug, and Cosmetic Act (21 U.S.C. 343) is amended by adding at the end the following:
  > - **(z)**
  >   - **(1)** If it uses the name for a standardized dairy product described in subparagraph (3) and the food does not meet—
  >     - **(A)** the criterion for being a dairy product, as described in subparagraph (2); or
  >     - **(B)** the requirements for imitation of another food under paragraph (c).
