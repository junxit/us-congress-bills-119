...
- **(c)** *GAO study* Not later than 180 days after the date of enactment of this Act, the Comptroller General of the United States shall submit to the Committee on Homeland Security and Governmental Affairs of the Senate and the Committee on Transportation and Infrastructure of the House of Representatives a report—
  ...
  - **(2)** that includes—
    - **(A)** the management costs described in section 324 of the Robert T. Stafford Disaster Relief and Emergency Assistance Act (42 U.S.C. 5165b) for each major disaster declared under section 401 of such Act (42 U.S.C. 5170) during the 5-year period preceding the date of the report;
    - **(B)** the amount set aside for those management costs;
    - **(C)** the use of those management costs;
    - **(D)** the length of each such major disaster; and
    - **(E)** the reason for the length of each such major disaster.
