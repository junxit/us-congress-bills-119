...
>     - **(B)** recommendations for priority actions to better coordinate, expand, and better support Federal programs in order to better support people with epilepsy, epilepsy research, and data collection; and
