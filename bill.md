...
- **(2)** in subsection (g)—
  ...
  - **(B)** in paragraph (1)—
    ...
    - **(ii)** by striking “by institutes which focuses” in the first sentence and all that follows through “Such funds when appropriated” in the second sentence and inserting the following:
