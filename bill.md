...
- **(b)** *Ineligible use of funds* Section 9909 of the William M. (Mac) Thornberry National Defense Authorization Act for Fiscal Year 2021 (15 U.S.C. 4659) is amended—
  ...
  - **(2)** by inserting after subsection (e) the following new subsection:
    ...
    >     - **(C)**
    >       - **(i)** the use of the ineligible semiconductor manufacturing equipment complies with the requirements set forth in the Export Administration Regulations (as such term is defined in section 1742 of the Export Control Reform Act of 2018 (50 U.S.C. 4801)); and
    ...
    >   - **(3)** *Foreign entities of concern* Nothing in this subsection may be construed to waive the application of section 9907.
