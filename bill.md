    ...
    - **(A)** in paragraph (1)—
      ...
      - **(iii)** in subparagraph (B) (as so designated)—
        ...
        - **(II)** by adding at the end the following:
          > - **(ii)** *Funding* Amounts made available to carry out this section may be used for the administrative costs of transfers of land and interests in land under this subsection.
