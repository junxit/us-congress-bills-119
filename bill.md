...
- **(b)** *Composition*
  ...
  - **(3)** *Prohibition on additional personnel*
    - **(A)** *In general* There shall be no personnel assigned or allocated to the Space National Guard other than the personnel provided for by paragraphs (1) and (2).
...
- **(a)** *In general* The Space National Guard shall make use of facilities, infrastructure, and installations constructed before the date of the enactment of this Act.
...
- **(a)** *Definitions*
  - **(1)** *Title 10, United States Code* Title 10, United States Code, is amended—
    - **(A)** in section 101—
      - **(i)** in subsection (c)—
        ...
        - **(II)** by redesignating paragraphs (6) and (7) as paragraphs (8) and (9), respectively; and
        - **(III)** by inserting after paragraph (5) the following new paragraphs:
  ...
  - **(2)** *Title 32, United States Code* Section 101 of title 32, United States Code is amended—
    ...
    - **(C)** by redesignating paragraphs (8) through (19) as paragraphs (10) through (21), respectively; and
