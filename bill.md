...
- **(a)** *Testing standards* Section 31305(a) of title 49, United States Code, is amended—
  ...
  - **(2)** in paragraph (5)—
    - **(A)** in subparagraph (B), by redesignating clauses (i) through (iv) as subclauses (I) through (IV), respectively, and indenting the subclauses appropriately; and
  ...
  - **(5)** in the matter preceding subparagraph (A) (as so redesignated)—
    ...
    - **(B)** in the first sentence, by striking “The Secretary of Transportation shall prescribe regulations on” and inserting the following:
      > - **(1)** *In general* The Secretary of Transportation (referred to in this section as the Secretary) shall prescribe regulations establishing
