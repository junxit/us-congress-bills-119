...
- **(a)** *In general* Section 1861 of the Social Security Act (42 U.S.C. 1395x) is amended—
  ...
  - **(2)** by adding at the end the following new subsection:
    ...
    >   - **(1)** The term covered genetic counseling services means genetic counseling services furnished on or after January 1, 2027, by a genetic counselor (as defined in paragraph (2)) and such services and supplies furnished as an incident to the provision of such services which the genetic counselor is legally authorized to perform under State law (or the State regulatory mechanism provided by State law) as would otherwise be covered if furnished by a physician (or as incident to a physician’s service).
...
- **(f)** *Implementation* Notwithstanding any other provision of law, the Secretary of Health and Human Services may implement the amendments made by this section by interim final rule with comment period.
