...
>   - **(2)** *Covered contracting program defined* In this subsection, the term covered contracting program means contracting assistance provided by the Administrator under following:
>     - **(A)** Section 8(a).
>     - **(B)** Section 8(m).
>     - **(C)** Section 31.
>     - **(D)** Section 36.
