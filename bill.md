...
- **(a)** *In general* Section 6(o) of the Food and Nutrition Act of 2008 (7 U.S.C. 2015(o)) is amended—
  - **(1)** in paragraph (2), in the matter preceding subparagraph (A), by inserting “, or, in the case of a parent or other member of a household with responsibility for a dependent child, 6 months (consecutive or otherwise),” before “during which”;
  - **(2)** in paragraph (3)—
  ...
  - **(3)** in paragraph (6)—
    ...
    - **(B)** in subparagraph (C), by striking “(G) and (I)” and inserting “(F) and (H)”;
    - **(C)** in subparagraph (D), by striking “(G) through (I)” and inserting “(F) through (H)”;
    - **(D)** by striking subparagraph (F);
    - **(E)** by redesignating subparagraphs (G) through (J) as subparagraphs (F) through (I), respectively; and
    - **(F)** in subparagraph (F) (as so redesignated), by striking “(C), (D),, (E), or (F)” and inserting “(C), (D), or (E)”.
