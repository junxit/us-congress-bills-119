  ...
  - **(1)** If the third-party delivery platform charges 1 or more delivery fees for an order from a retail establishment, any such delivery fee shall be—
    ...
    - **(B)** based solely on—
      ...
      - **(ii)** other factors related to the delivery of the items ordered from the retail establishment, including the delivery distance, but excluding—
        - **(I)** any other factor that directly or indirectly relies on, incorporates, or is informed by variables that serve as a proxy for characteristics of the user placing the order or a class of users, including inferred price sensitivity, prior purchasing behavior, or willingness to pay; and
