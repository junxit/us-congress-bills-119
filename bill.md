...
- **(1)** in paragraph (1)—
  ...
  - **(B)** by inserting before subparagraph (C), as so redesignated, the following:
    ...
    >   - **(ii)** any covered nation (as defined in section 4872(f)(2) of title 10, United States Code);
...
- **(3)** by adding at the end the following:
  > - **(5)** *Trading prohibition* If a covered issuer that is headquartered in a covered country retains a compromised auditor to prepare an audit report described in paragraph (2)(A) for the covered issuer, the trading prohibition described in paragraph (3) shall apply to the covered issuer.
