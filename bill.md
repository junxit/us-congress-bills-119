...
- **(1)** in paragraph (1)—
  - **(A)** by striking “determines that the participation” and inserting the following:
    > determines that—
...
- **(3)** by inserting after paragraph (2) the following:
  ...
  > - **(5)** *Spousal exclusion* Notwithstanding any other provision of this Act, a spouse of an individual eligible for benefits under the supplemental nutrition assistance program shall not be eligible to participate in the program under this subsection.

- **(4)** in paragraph (6) (as so redesignated), by striking “Senate a report on the effectiveness of a” and inserting the following:
  > Senate, and make publicly available, a report describing—
