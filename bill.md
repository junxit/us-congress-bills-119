...
- **(b)** *Operations, functions, and services* The operations, functions, and services described in this subsection are the operations, functions, and services of—
  ...
  - **(4)** the Directorate of Defense Trade Controls of the Department of State relating to firearms and firearm-related products, including activities related to processing of applications for export licenses.
