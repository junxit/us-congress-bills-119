...
- **(1)** *Child* The term child means, regardless of age, a biological, foster, or adopted child, a stepchild, a child of a domestic partner, a legal ward, or a child of a person standing in loco parentis.
...
- **(5)** *Employee* The term employee means an individual who is—
  - **(A)**
    ...
    - **(iii)** an employee of a covered employer described in paragraph (6)(B)(i)(IV) who performs work that has been traditionally performed by employees in a railroad industry craft or class recognized under the Ninth paragraph of section 2 of the Railway Labor Act (45 U.S.C. 152), including any employee who performs—
...
- **(a)** *Earning of paid sick time*
  ...
  - **(8)** *Prohibition* An employer may not require, as a condition of providing paid sick time under this Act, that the employee involved search for or find a replacement employee to cover the hours during which the employee is using paid sick time.
...
- **(a)** *Compilation of information* The Commissioner of Labor Statistics of the Department of Labor shall annually compile and report to the Comptroller General of the United States information on—
  - **(1)** the amount of paid sick time available to employees by occupation and type of employment establishment; and
