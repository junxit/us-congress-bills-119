...
## § 2. Registration with the Secretary of the Treasury
...
- **(1)** in subsection (d)—
  ...
  - **(B)** by adding at the end the following:
    > - **(3)** *Virtual currency; virtual currency address; virtual currency kiosk; virtual currency kiosk operator* The terms virtual currency, virtual currency address, virtual currency kiosk, and virtual currency kiosk operator have the meanings given those terms, respectively, in section 5337.
...
- **(2)** by adding at the end the following:
  ...
  >   - **(3)** *False and incomplete information* The filing of false or materially incomplete information in a submission required under paragraph (1) shall be deemed a failure to comply with the requirements of this subsection.

## § 3. Preventing fraudulent transactions at virtual currency kiosks
...
- **(b)** *Clerical amendment* The table of sections for chapter 53 of title 31, United States Code, is amended by inserting after the item relating to section 5336 the following:
