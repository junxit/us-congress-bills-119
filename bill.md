...
- **(2)** by adding at the end the following:
  ...
  >     - **(B)** for existing or additional full-time equivalent positions above the number of positions that were held in the State or sub-State area in fiscal year 2024.
