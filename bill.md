...
- **(a)** *Disposal*
  ...
  - **(3)** *Discretion of Administrator regarding transactions*
    - **(A)** *In general* For any disposal under paragraph (1), the Administrator may approve sale or ground lease transactions under such terms and conditions that the Administrator determines are in the best interests of the United States.
  ...
  - **(4)** *Exemption from certain requirements* Except as provided in subsection (e)(1)(D), a disposal under paragraph (1) shall be exempt from the requirements of, as applicable—
...
- **(e)** *Miscellaneous provisions*
  - **(1)** *Additional Federal buildings to be disposed*
    ...
    - **(D)** *Exemptions from certain requirements* With respect to a Federal building described in subparagraph (B) that is added to the list of Federal buildings described in subsection (a)(1) pursuant to subparagraph (A) and disposed of pursuant to subsection (a)(1)—
  ...
  - **(4)** *Sunset*
    ...
    - **(B)** *Effect on prior actions* The termination of authority under subparagraph (A) shall not affect—
      ...
      - **(ii)** the continued enforcement or implementation of any final rule, order, agreement, or decision issued pursuant to that authority prior to that termination.
