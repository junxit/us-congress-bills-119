...
- **(b)** *Plan requirements* The plan required under subsection (a) shall include the following:
...
- **(d)** *Limitation on expansion* Until such time as the Secretary of Homeland Security submits the plan required under subsection (a) and certifies commencement of the implementation of such plan under subsection (c), the Secretary may not—
...
- **(e)** *Definitions* In this section:
  ...
  - **(2)** *ELO Office* The term “ELO Office” means the Engagement, Liaison, and Outreach office within the Office of Intelligence and Analysis (I&A) of the Department of Homeland Security.
