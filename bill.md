...
- **(a)** *Exemption from volume cap*
  - **(1)** *In general* Section 146(g) of the Internal Revenue Code of 1986 is amended by redesignating paragraphs (2) through (6) as paragraphs (3) through (7), respectively, and by inserting after paragraph (1) the following new paragraph:
...
- **(b)** *Exemption from alternative minimum tax* Section 57(a)(5)(C) of the Internal Revenue Code of 1986 is amended by redesignating clauses (iv), (v), and (vi) as clauses (v), (vi), and (vii), respectively, and by inserting after clause (iii) the following new clause:
...
- **(c)** *Effective dates* The amendments made by this section shall apply to obligations issued after the date of the enactment of this Act.
