...
- **(a)** *Rates* Section 1097b(a) of title 10, United States Code, is amended—
  ...
  - **(2)** in paragraph (3), by striking “In establishing” and inserting the following:
    > - **(A)**
    >   - **(i)** Except as provided by paragraph (1), if the Secretary may determine among more than one reimbursement rate to pay a health care provider for care or services provided under the TRICARE program, the Secretary shall pay the lowest rate authorized for such care or services.
