...
- **(a)** *Establishment*
  ...
  - **(3)** *Consultation*
    ...
    - **(B)** *Topics* The consultation with stakeholders and entities described in subparagraph (A)(iii) shall be with respect to elements of the dashboard, such as search functions, grant data, user-friendly design, and any other elements that the Secretary determines are appropriate for purposes of this subsection.
