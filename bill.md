...
- **(a)** *In general* Not later than 180 days after the date of the enactment of this Act, the Administrator of the Small Business Administration shall issue rules as follows:
  - **(1)** Requiring disclosure of information about a covered solicitation that was issued and cancelled that includes the following:
